...
1. [개요](#1-개요)
2. [파서 옵션 비교](#2-파서-옵션-비교)
3. [BDA 파서가 처리하는 데이터 유형](#3-bda-파서가-처리하는-데이터-유형)
4. [파일 처리 제한 사항](#4-파일-처리-제한-사항)
5. [BDA 파서 동작 방식](#5-bda-파서-동작-방식)
6. [API 구성 방법](#6-api-구성-방법)
7. [Cross-Region Inference (CRIS) 필수 요건](#7-cross-region-inference-cris-필수-요건)
8. [IAM 권한 구성](#8-iam-권한-구성)
9. [멀티모달 스토리지 설정](#9-멀티모달-스토리지-설정)
10. [임베딩 모델과의 조합](#10-임베딩-모델과의-조합)
11. [주요 활용 사례](#11-주요-활용-사례)
12. [참고 문서 링크](#12-참고-문서-링크)
